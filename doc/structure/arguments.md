...
[![test](.test/argument_match_name.png)](.test/argument_match_name.md)
...
[![test](.test/argument_match_type.png)](.test/argument_match_type.md)
...
[![test](.test/argument_match_mix.png)](.test/argument_match_mix.md)
...
[![test](.test/tuple_match.png)](.test/tuple_match.md)
...
[![test](.test/tuple_match_variants.png)](.test/tuple_match_variants.md)
...
[![test](.test/tuple_match_errors.png)](.test/tuple_match_errors.md)
...
[![test](.test/tuple_match_warnings.png)](.test/tuple_match_warnings.md)
...
[![test](.test/multiplicity_arrays.png)](.test/multiplicity_arrays.md)
...
[![test](.test/no_multiplicity.png)](.test/no_multiplicity.md)
...
[![test](.test/multiplicity_tuple_array.png)](.test/multiplicity_tuple_array.md)
