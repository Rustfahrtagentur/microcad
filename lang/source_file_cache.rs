...
pub struct SourceFileCache {
    ...
    source_files: std::collections::HashMap<u64, Rc<SourceFile>>,
    /// Source files by name
    source_files_by_name: std::collections::HashMap<String, Rc<SourceFile>>,
}

/// Source file cache, used to keep track of loaded source files
impl SourceFileCache {
    /// Add a new source file to the cache
    pub fn add(&mut self, source_file: Rc<SourceFile>) {
