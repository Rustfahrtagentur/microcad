...
pub trait Algorithm: std::fmt::Debug {
    ...
    fn process_2d(&self, _renderer: &mut dyn Renderer2D, _parent: ModelNode) -> Result<crate::geo2d::Node> {
        unimplemented!()
    }

    /// Processes geometry for a 3d renderer and returns a geometry
    fn process_3d(&self, _renderer: &mut dyn Renderer3D, _parent: ModelNode) -> Result<crate::geo3d::Node> {
        unimplemented!()
    }
}
