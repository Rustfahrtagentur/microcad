...
use microcad_lang::{eval::Builtin, objects::*, resolve::*, syntax::Identifier, value::Value};

/// Creates a node containing a difference algorithm
fn difference() -> Symbol {
    Symbol::new_builtin(Builtin::new(Identifier::no_ref("difference"), &|_, _| {
...
fn union() -> Symbol {
    Symbol::new_builtin(Builtin::new(Identifier::no_ref("union"), &|_, _| {
...
fn intersection() -> Symbol {
    Symbol::new_builtin(Builtin::new(Identifier::no_ref("intersection"), &|_, _| {
...
fn complement() -> Symbol {
    Symbol::new_builtin(Builtin::new(Identifier::no_ref("complement"), &|_, _| {
